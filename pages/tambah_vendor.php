...
$page_title = 'Tambah Vendor - UAS Pengadaan';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO vendors (name, contact_person, phone, email, address, npwp, status) 
            VALUES ('$name', '$contact_person', '$phone', '$email', '$address', '$npwp', '$status')";
    
    if (mysqli_query($koneksi, $sql)) {
        header("Location: vendor.php?msg=added");
        exit();
    } else {
        $error = "Gagal menambah vendor: " . mysqli_error($koneksi);
    }
}
?>
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <h1><i class="fas fa-user-plus"></i> Tambah Vendor</h1>
        </div>
    </div>
